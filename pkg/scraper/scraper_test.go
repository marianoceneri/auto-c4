...
import (
	...
	"github.com/marianoceneri/auto-c4/pkg/internal"
	"github.com/marianoceneri/auto-c4/pkg/internal/test"
	"github.com/marianoceneri/auto-c4/pkg/model"
	"github.com/marianoceneri/auto-c4/pkg/scraper"
	"github.com/stretchr/testify/require"
)

const (
	testPKG = "github.com/marianoceneri/auto-c4/pkg/internal/test"
)
...
func TestScraper_Scrape_package_matching(t *testing.T) {
	var tests = []struct {
		...
		},
		{
			...
			structure: test.NewRootEmptyHasInfo(),
			packages: []string{
				"github.com/marianoceneri/auto-c4/pkg/foo",
			},
		...
		},
		{
			...
			structure: test.NewRootEmptyHasInfo(),
			packages: []string{
				"github.com/marianoceneri/auto-c4pkg",
			},
			expectedNumberOfComponents: 1,
		},
	}
...
func TestScraper_Scrape_rules(t *testing.T) {
	...
	ruleMatchPublicComponentInAnotherPackage, err := scraper.NewRule().
		WithPkgRegexps("^github.com/marianoceneri/auto-c4/pkg/foo$").
		WithNameRegexp("^test.PublicComponent$").
		WithApplyFunc(func(name string, groups ...string) model.Info {
			return model.ComponentInfo()
		}).
